...
public class Ad {
    ...
    public Ad(int id, int shownCounter, int type, Double advertiserPaid, LocalDate expirationDate, LocalDate startDate, String advertiser, String shownUrl, String imgLocalPath, String text, String videoPath) {
        this.id = id;
        this.shownCounter = shownCounter;
        this.type = type;
        this.advertiserPaid = advertiserPaid;
